    ...
    public static class Commands
    {
        ...
        static Commands()
        {
            _handlers = new Dictionary<string, IngameCommandHandler>
                ...
                {"mapid", Process_What_Map},
                {"come", Process_Call_Player},
                {"go", Process_Goto_Player},
                {"kick", Process_Kick_Player},
                {"maint", Process_Server_Maint},
                {"online", Process_Players_Online},
                {"clear", Process_Clear_Inventory},
                {"whereis", Process_Find_Player},
                {"gwstart", Process_Start_Guild_War},
                {"gwend", Process_End_Guild_War},
                {"move", Process_Move_Player},
            };
        }
