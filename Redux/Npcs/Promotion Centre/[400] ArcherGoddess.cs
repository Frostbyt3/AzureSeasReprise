        ...
        public override void Run(Game_Server.Player client, ushort linkback)
        {
            ...
            switch (linkback)
            {
                ...
                case 1:
                    switch (client.ProfessionLevel)
                    {
                        case 0:
                            ...
                            AddText("Are you ready for promotion?");
                            AddOption("Yes, please.", 2);
                            AddOption("No.", 255);
                            break;
                        case 1:
                            AddText("You may become an Eagle Archer at level 40. ");
                            AddText("Are you ready for promotion?");
                            AddOption("Yes, I do.", 2);
                            AddOption("No.", 255);
                            break;
                        case 2:
                            AddText("You may promote to a Tiger Archer at level 70. ");
                            AddText("I will require one Emerald. I hear they are dropped by monsters in the desert. ");
                            AddText("Are you ready for promotion?");
                            AddOption("I'm ready!", 2);
                            AddOption("I'm not sure...", 255);
                            break;
                        case 3:
                            AddText("You may promote to a Dragon Archer at level 100. I will require one Meteor. ");
                            AddText("Are you ready for promotion?");
                            AddOption("I'm ready!", 2);
                            AddOption("I'm not sure...", 255);
                            break;
                        case 4:
                            AddText("You may promote to an Archer Master at level 110. I will require one Moon Box. ");
                            AddText("Are you ready for promotion?");
                            AddOption("I'm ready!", 2);
                            AddOption("I'm not sure...", 255);
                            break;
                        case 5:
                            AddText("You are a master of the bow. I cannot promote you anymore!");
                            AddOption("I see.", 255);
                            break;
                    }
                    break;
                ...
                case 5:
                    if (client.Level >= 23)
                    {
                        AddText("You have learned Scatter!");
                ...
                case 6:
                    if (client.Level >= 46)
                    {
                        AddText("You have learned Rapid Fire!");
                ...
                case 7:
                    if (client.Level >= 71)
                    {
                        AddText("You have learned Intensify!");
                ...
                case 9:
                    if (client.Level >= 70)
                    {
                        AddText("You have learned Advanced Fly!");
                ...
                case 10:
                    if (client.Level >= 70)
                    {
                        AddText("You have learned Arrow Rain!");
