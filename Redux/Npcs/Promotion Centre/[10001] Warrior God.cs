    ...
    public class NPC_10001 : INpc
    {
        ...
        public override void Run(Game_Server.Player client, ushort linkback)
        {
            ...
            switch (linkback)
            {
                ...
                case 0:
                    AddText("To be a good Warrior, you must know your weapon, your armor as a second ");
                    AddText("skin, and use your shield to ward off your enemy! Remember, fortune favors ");
                ...
                case 1:
                    switch (client.ProfessionLevel)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            AddText("You may become a Brass Warrior at level 40. Are you ready for promotion?");
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            AddText("You have mastered your weapon and your shield. I cannot promote you anymore!");
                            AddOption("I see.", 255);
                            break;
                    }
                    break;
                    ...
                    switch (client.ProfessionLevel)
                    {
                        ...
                        case 1://level 40
                            ...
                            else
                            {
                                ...
                                AddText("Strength: 80, Agility: 25, Vitality: 20. ");
                        ...
                        case 2://level 70
                            ...
                            else
                            {
                                ...
                                AddText("Strength: 140, Agility: 45, Vitality: 32. ");
                                AddText("I will not promote you yet.");
                                AddOption("I'll work harder.", 255);
                            }
                            break;
                        case 3://level 100
                            ...
                            else
                            {
                                ...
                                AddText("Strength: 205, Agility: 60, Vitality: 42. ");
                                AddText("I will not promote you yet.");
                                AddOption("I'll work harder.", 255);
                            }
                            break;
                        case 4://level 110
                            ...
                            else
                            {
                                ...
                                AddText("Strength: 225, Agility: 65, Vitality: 47. ");
                                AddText("I will not promote you yet.");
                                AddOption("I'll work harder.", 255);
                            }
                            break;
                ...
                case 4:
                    if (client.Level >= 15)
                    {
                        AddText("You have learned your XP skills!");
                        client.CombatManager.LearnNewSkill(SkillID.Accuracy);
                        client.CombatManager.LearnNewSkill(SkillID.Shield);
                        client.CombatManager.LearnNewSkill(SkillID.Superman);
                        client.CombatManager.LearnNewSkill(SkillID.Roar);
