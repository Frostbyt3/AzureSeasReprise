...
namespace Redux.Npcs
{
    ...
    {
        /// <summary>
        /// Handles NPC usage for [10022] TrojanStar
        /// </summary>
        ...
        public override void Run(Game_Server.Player client, ushort linkback)
        {
            ...
            switch (linkback)
            {
                ...
                case 1:
                    switch (client.ProfessionLevel)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            AddText("You may become a Veteran Trojan at level 40. Are you ready for promotion?");
                            AddOption("Yes, I do.", 2);
                            AddOption("No.", 255);
                            break;
                        case 2:
                            AddText("You may promote to a Tiger Trojan at level 70. ");
                            ...
                            break;
                        case 3:
                            AddText("You may promote to a Dragon Trojan at level 100. ");
                            AddText("I will require one Meteor. Are you ready for promotion?");
                            AddOption("I'm ready!", 2);
                            AddOption("I'm not sure...", 255);
                            break;
                        case 4:
                            AddText("You may promote to a Trojan Master at level 110.");
                            AddText(" I will require one Moon Box. Are you ready for promotion?");
                            AddOption("I'm ready!", 2);
                            AddOption("I'm not sure...", 255);
                            break;
                        case 5:
                            AddText("You have mastered dual weapons. I cannot promote you anymore!");
                            AddOption("I see.", 255);
                            break;
                    }
                    break;
                    ...
                    switch (client.ProfessionLevel)
                    {
                        ...
                        case 1://level 40
                            ...
                            else
                            {
                                ...
                                AddText("Strength: 60, Agility: 25, Vitality: 25. ");
                        ...
                        case 2://level 70
                            ...
                            else
                            {
                                ...
                                AddText("Strength: 110, Agility: 42, Vitality: 45. ");
                                AddText("I will not promote you yet.");
                                AddOption("I'll work harder.", 255);
                            }
                            break;
                        ...
                        case 4://level 110
                            ...
                            else
                            {
                                ...
                                AddText("Strength: 170, Agility: 65, Vitality: 100. ");
                                AddText("I will not promote you yet.");
                                AddOption("I'll work harder.", 255);
                            }
                            break;
                ...
                case 4:
                    if (client.Level >= 15)
                    {
                        AddText("You have learned Cyclone and Accuracy!");
                        client.CombatManager.LearnNewSkill(SkillID.Cyclone);
                        client.CombatManager.LearnNewSkill(SkillID.Accuracy);
                    }
                    else
                ...
                case 5:
                    if (client.Level >= 40)
                    {
                        AddText("You have learned Hercules!");
                ...
                case 6:
                    if (client.Level >= 40)
                    {
                        AddText("You have learned Spirit Healing!");
                ...
                case 7:
                    if (client.Level >= 40)
                    {
                        AddText("You have learned to transform into a Robot!");
